...
-- Comunas
--
DROP TABLE IF EXISTS `tb_comunas`;
...
INSERT INTO `tb_comunas` (`id`,`comuna`,`tb_provincia_id`)
VALUES
	(1,'Arica',1),
	(2,'Camarones',1),
	(3,'General Lagos',2),
...
INSERT INTO `tb_provincias` (`id`,`provincia`,`tb_region_id`)
VALUES
	(1,'Arica',1),
	(2,'Parinacota',1),
	(3,'Iquique',2),
...
INNER JOIN provincias ON 
	comunas.tb_provincia_id = provincias.tb_provincia_id
INNER JOIN regiones ON
	provincias.id = regiones.tb_region_id
