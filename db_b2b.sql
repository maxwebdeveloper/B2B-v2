...
-- Tiempo de generación: 29-12-2016 a las 06:57:38
...
CREATE TABLE `mv_ficha_evaluacion` (
  ...
  `variedades` varchar(150) DEFAULT NULL,
  `atributos_principales` varchar(150) DEFAULT NULL,
  `beneficios` varchar(150) DEFAULT NULL,
  `posicionamiento` varchar(45) DEFAULT NULL,
  `costo_neto` varchar(45) DEFAULT NULL,
  ...
  `rentabilidad` varchar(45) DEFAULT NULL,
  `Innovacion` varchar(45) DEFAULT NULL,
  `desarrollo_proveedor` varchar(45) DEFAULT NULL,
  `expancion_de_linea` varchar(45) DEFAULT NULL,
  `comentario` varchar(250) DEFAULT NULL,
  `precio_lista_neto` varchar(45) DEFAULT NULL,
  `pvps` varchar(45) DEFAULT NULL,
  ...
  `tb_formato_consumo_id` int(11) NOT NULL
...
INSERT INTO `tb_region` (`id`,`region`,`region_ordinal`)
VALUES
...
INSERT INTO `tb_provincia` (`id`,`provincia`,`tb_region_id`)
VALUES
  (1,'Arica',1),
  (2,'Parinacota',1),
  (3,'Iquique',2),
...
INSERT INTO `tb_comuna` (`id`,`comuna`,`tb_provincia_id`)
VALUES
  (1,'Arica',1),
  (2,'Camarones',1),
  (3,'General Lagos',2),
